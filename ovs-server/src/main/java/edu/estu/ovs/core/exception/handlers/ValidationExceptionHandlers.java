...
import edu.estu.ovs.core.results.abstracts.ApiSubError;
import edu.estu.ovs.core.results.error.ApiErrorDataResult;
import edu.estu.ovs.core.results.error.suberrors.ApiValidationError;
...
public class ValidationExceptionHandlers {
    ...
    public ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex) {
        ...
        return ResponseEntity.badRequest().body(new ApiErrorDataResult<>(ex, Msg.INVALID, Stream.concat(fieldErrors, objErrors).collect(Collectors.toList())));
    }
    ...
    public ResponseEntity<Object> handleConstraintViolation(ConstraintViolationException ex) {
        ...
        return ResponseEntity.badRequest().body(new ApiErrorDataResult<>(ex, Msg.INVALID, errors));
    }
